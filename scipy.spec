...
%define optflags	-O3 -funroll-loops -mtune=power9 -mcpu=power8 -maltivec -mvsx -mpower8-fusion -mpower8-vector -mfloat128 -malign-power -fprefetch-loop-arrays -fopenmp  -mveclibabi=mass -lmass -lmassvp8 -lmass_simdp8 -I/opt/oss-mldl/include  -fpeel-loops -fvect-cost-model -mcmodel=medium  -mhtm -L/opt/ibm/xlmass/8.1.6/lib -L/opt/ibm/xlsmp/4.1.6/lib -L/opt/ibm/xlC/13.1.6/lib -L/opt/ibm/xlf/15.1.6/lib -Wl,-rpath=/opt/oss-mldl/lib -lgomp -mpopcntd -mabi=altivec  -mpowerpc-gpopt -lhugetlbfs -shared
%define lb_flags	-L/opt/ibm/xlmass/8.1.6/lib -L/opt/ibm/xlsmp/4.1.6/lib -L/opt/ibm/xlC/13.1.6/lib -L/opt/ibm/xlf/15.1.6/lib -lm -lpthread -lmass -lmass_simdp8 -lmassvp8 -Wl,-rpath=/opt/oss-mldl/lib -lhugetlbfs -shared
%define	lb_list		-lmass -lmass_simdp8 -lmassvp8 -lm -L/opt/ibm/xlmass/8.1.6/lib -L/opt/ibm/xlsmp/4.1.6/lib -L/opt/ibm/xlC/13.1.6/lib -L/opt/ibm/xlf/15.1.6/lib -lhugetlbfs -shared

%define name		scipy
%define release     	pslq_gcc_huge
%define version		1.0.0
%define _topdir		/home/pqueiroz/pacotes/scipy-1.0.0
%define buildroot	%{_topdir}/%{name}-%{version}-root

BuildRoot:	%{buildroot}
Summary:        PSLQ Compilation of scipy
Name:           %{name}
License:	BSD
Version:        %{version}
Release:        %{release}
Source:         scipy-1.0.0.tar.gz
Prefix:         /opt/oss-mldl
...
%description
PSLQ Compilation of scipy on top of Advance Toolchain and IBM mathematical Libraries
...
F77FLAGS="%{optflags}" CFLAGS="%{optflags}" CXXFLAGS="%{optflags}" FCFLAGS="%{optflags}" CPPFLAGS="-I/opt/OpenBLAS/include " LDFLAGS="%{lb_flags}" LIBS="%{lb_list}" /opt/oss-mldl/bin/python3 setup.py build
