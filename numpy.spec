...
%define _topdir		/home/pqueiroz/pacotes/numpy-1.14.0
%define buildroot	%{_topdir}/%{name}-%{version}-root

BuildRoot:	%{buildroot}
Summary:        PSLQ Compilation of NumPy
Name:           %{name}
License:	BSD
Version:        %{version}
Release:        %{release}
Source:         numpy-1.14.0.zip
Prefix:         /opt/oss-mldl
...
%description
PSLQ Compilation of NumPy on top of Advance Toolchain and IBM mathematical Libraries
