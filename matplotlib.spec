...
%define _topdir		/home/pqueiroz/pacotes/matplotlib-2.1.2
%define buildroot	%{_topdir}/%{name}-%{version}-root

BuildRoot:	%{buildroot}
Summary:        PSLQ Compilation of matplotlib
Name:           %{name}
License:	APL
Version:        %{version}
Release:        %{release}
Source:         matplotlib-2.1.2.tar.gz 
Prefix:         /opt/oss-mldl
...
%description
PSLQ Compilation of matplotlib on top of Advance Toolchain and IBM mathematical Libraries
